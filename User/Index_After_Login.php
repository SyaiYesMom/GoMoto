    ...
    <main>
        ...
        <section class="container mx-auto py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <a href="Product\Naked.php" class="block" style="width: 233.8px; height: 512px;">
                    <img alt="Naked motorcycle" src="..\Source\INDEX\NAKED_INDEX.png"/>
                    <h2><b>NAKED</b></h2>
                    <p>Rasakan performa bertenaga, desain aerodinamis, dan fitur canggih dari motor Naked terbaik. Temukan model impian Anda dari merek ternama seperti Yamaha, Honda, dan Suzuki. Berkendara penuh aksi dimulai di sini!</p>
                </a>
                <a href="Product\Trail.php" class="block" style="width: 233.8px; height: 512px;">
                ...
                <a href="Product\Scoopy.php" class="block" style="width: 233.8px; height: 512px;">
                ...
                <a href="Product\Underbone.php" class="block" style="width: 233.8px; height: 512px;">
