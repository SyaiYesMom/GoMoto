...
$productName = 'Honda Vario 125'; // Tetapkan nilai productName
...
<body class="Body">
  ...
  $productName = 'Honda Vario 125'; // Specify the product name
  ...
  <main class="flex flex-col items-center mt-8">
    <div style="width: 1400px; height: 728px;" class="text-center">
      ...
      <!-- Motorcycle Image -->
      <img 
        src="..\..\Source\INDEX\PRODUCT\SCOOPY\CO\<?php echo $product['NAMA_PRODUK']; ?>.jpg" 
        alt="Trail" 
