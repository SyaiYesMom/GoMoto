...
$productName = 'Yamaha Jupiter Z1'; // Tetapkan nilai productName
$_SESSION['productName'] = $productName; // Simpan productName ke session
?>
...
<body class="Body">
  ...
  $productName = 'Yamaha Jupiter Z1'; // Specify the product name
  ...
  <main class="flex flex-col items-center mt-8">
    <div style="width: 1400px; height: 728px;" class="text-center">
      ...
      <!-- Motorcycle Image -->
      <img 
        src="..\..\Source\INDEX\PRODUCT\UNDERBONE\CO\<?php echo $product['NAMA_PRODUK']; ?>.jpg" 
        alt="Trail" 
