    ...
    <main>
        ...
        <section class="container mx-auto py-12">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                $product_names = ['Viar New Cross X 150', 'Gazgas Raptor 100', 'Kawasaki KLX 230', 'Yamaha Trail WR 155'];
                ...
                foreach ($product_names as $product_name) {
                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo "<a href='CO_" . str_replace(' ', '_', htmlspecialchars($row['NAMA_PRODUK'])) . ".php' class='block' style='width: 233.8px; height: 512px>";
