...
$productName = 'Suzuki GSX-S150'; // Tetapkan nilai productName
...
<body class="Body">
  ...
  $productName = 'Suzuki GSX-S150'; // Specify the product name
  ...
  <main class="flex flex-col items-center mt-8">
    <div style="width: 1400px; height: 728px;" class="text-center">
      ...
      <!-- Motorcycle Image -->
      <img 
        src="..\..\Source\INDEX\PRODUCT\NAKED\CO\<?php echo $product['NAMA_PRODUK']; ?>.jpg" 
        alt="Trail" 
